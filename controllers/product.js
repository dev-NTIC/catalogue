...
exports.create = async (req, res) => {
  ...
  productimg ? productimg = '/uploads/' + productimg[0].filename : productimg = '';
  banner ? banner = '/uploads/' + banner[0].filename : banner = '';
  techsheet ? techsheet = '/uploads/' + techsheet[0].filename : techsheet = '';
  // ---------------------------- CHECKBOXES --------------------------------
...
exports.update = async (req, res) => {
  ...
  // ------------------------------ FILES -----------------------------------
  var {productimg, banner, techsheet} = req.files
  productimg ? productimg = '/uploads/' + productimg[0].filename : productimg = pre_productimg;
  banner ? banner = '/uploads/' + banner[0].filename : banner = pre_banner;
  techsheet ? techsheet = '/uploads/' + techsheet[0].filename : techsheet = pre_techsheet;
  // ---------------------------- CHECKBOXES --------------------------------
  is_new ? is_new = 'true' : is_new = 'false';
  is_available ? is_available = 'true' : is_available = 'false';
  is_bestselling ? is_bestselling = 'true' : is_bestselling = 'false';
